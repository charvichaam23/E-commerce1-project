...
<li class="active"><a href="<c:url value='/ContactUs'></c:url>"><span class="glyphicon glyphicon-earphone"></span>ContactUs</a></li>
  ...
  <li class="active"><a href="<c:url value='/admin/getproductform'></c:url>"><span class="glyphicon glyphicon-plus"></span>Add Product</a></li>
    <li class="active"><a href="<c:url value='/admin/getcategoryform'></c:url>"><span class="glyphicon glyphicon-plus"></span>Add category</a></li>
    <li class="active"><a href="<c:url value='/admin/getsupplierform'></c:url>"><span class="glyphicon glyphicon-plus"></span>Add supplier</a></li>
